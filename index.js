...
(function () {
  ...
  Runner.prototype = {
    ...
    adjustDimensions: function () {
      ...
      var padding = Number(boxStyles.paddingLeft.substring(0, 0+boxStyles.paddingLeft.length - 2));
    ...
    setArcadeModeContainerScale() {
      ...
      const translateY = Math.ceil(
        Math.max(0, (windowHeight - scaledCanvasHeight - Runner.config.ARCADE_MODE_INITIAL_TOP_POSITION)
  ...
  function createCanvas(container, width, height, opt_classname) {
    ...
    canvas.className = opt_classname ?  Runner.classes.CANVAS + ' ' + opt_classname :
    ...
    reset: function () {
      ...
      this.nightMode.reset();
        ...
        resize: function (width, height) {
          console.log('aaa Horizon::resize s');
          this.canvas.width = width;
          this.canvas.height = height;
          console.log('aaa Horizon::resize e');
      },
